  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center" dir="rtl">
      <div className="max-w-4xl mx-auto px-4 text-center">
        <div className="mb-8">
          <div className="w-40 h-40 rounded-2xl flex items-center justify-center mx-auto mb-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-lg border border-blue-100">
            ...
            <h3 className="text-lg font-semibold mb-2">فرم ثبت مشاوره</h3>
            <p className="text-gray-600 text-sm">درخواست مشاوره خودتون رو ثبت کنید</p>
          </div>
