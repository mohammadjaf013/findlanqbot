      ...
      <div className="bg-gray-50 text-gray-800 antialiased">
        ...
        <header className="bg-white/80 backdrop-blur-sm sticky top-0 z-50 shadow-sm border-b border-gray-200">
          <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <Link href="/" className="text-xl font-bold text-gray-900">کیوچت</Link>
        </div>
            ...
            <div className="hidden md:block">
              <Link href="/finlandq4" className="bg-blue-600 text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-blue-700 transition-all duration-300 shadow-sm">
                شروع چت با کیو
              </Link>
          </div>
          ...
          <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} md:hidden bg-white border-t border-gray-200`}>
            ...
            <div className="p-4">
              <Link href="/finlandq4" className="w-full block text-center bg-blue-600 text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-blue-700 transition-all duration-300 shadow-sm">
              شروع چت با کیو
              </Link>
            </div>
          </div>
        ...
        <main>
         ...
         <div className='flex justify-center items-center'>
          <img src="qchat.png" alt=" فنلاند کیو" className="md:h-40 md:w-40 object-contain h-[60%] w-[60%]" />
         </div>
